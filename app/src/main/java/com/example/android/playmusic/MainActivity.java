...
public class MainActivity extends AppCompatActivity
{
    ...
    private void initViewPager()
    {
        ...
        viewPagerAdapter.addFragemnts(new SongsFragment(),"Songs");
        viewPagerAdapter.addFragemnts(new AlbumFragment(),"Albums");
    ...
    public static class ViewPagerAdapter extends FragmentPagerAdapter
    {
        ...
        void addFragemnts(Fragment fragment,String title)
        {
